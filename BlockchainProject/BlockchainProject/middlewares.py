...
from .settings import IPPOOLPath
...
class IPPOOlS(object):
	...
	def getIPPool(self,path):
		with open(path,'r') as f:
			self.IPPOOL=f.readlines()
		
	
	def process_request(self, request, spider):
		with open(IPPOOLPath,'r') as f:
			self.IPPOOL=f.readlines()
		# 先随机选择一个IP
...
class BlockchainprojectDownloaderMiddleware(object):
	# Not all methods need to be defined. If a method is not defined,
